<div class="modal fade" id="editCallModal" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Edit a Call</h5>
                <button type="button" class="close" data-dismiss="modal">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form method="POST" action="{{ route('calls.update') }}" id="edit-form">
                    @csrf
                    @method('PUT')
                        ...
                        <div class="col-6">
                            ...
                            <div class="form-row">
                                <div class="form-group col-6">
                                    <input type="number" class="form-control" name="duration[]" min="1" max="30"
                                        id="minutes">
            ...
            <div class="modal-footer">
                <button form="edit-form" type="submit" class="btn btn-sm btn-success">Update Call</button>
            </div>
        </div>
    </div>
</div>
